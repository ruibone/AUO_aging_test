...
def runall_ExtraTreesC(num_set, trainset_x, test_x, trainset_y, test_y, config, record_bad = True):
...
table_set1 = runall_ExtraTreesC(10, trainset_x, run_test_x, trainset_y, run_test_y, best_paramC, record_bad = False)
line_chart(table_set1, title = 'ExtraTrees Classifier')
...
pr_dict, table_set2 = runall_ExtraTreesR(10, trainset_x, run_test_x, trainset_y, run_test_y, best_paramR, 
                                         thres_target = 'Recall', threshold = 0.8, record_bad = False)
line_chart(table_set2, title = 'ExtraTrees Regressor')
...
optuna_history(best_paramC, all_scoreC, model = 'ExtraTrees Classifier')
